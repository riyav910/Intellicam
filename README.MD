...
colorFrom: blue
colorTo: green
sdk: gradio  # or streamlit, depending on what you're using
sdk_version: 3.50.2  # or the correct version you're using
app_file: app.py  # or the main file you want HF to run
pinned: false
license: mit
---
